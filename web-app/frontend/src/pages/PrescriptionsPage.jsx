...
import { Search, Filter, Plus, Pill, ChevronRight, Clock, CheckCircle, AlertCircle, X } from 'lucide-react'
        ...
        <main className="flex-1 p-6">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-slate-400">Manage and monitor all patient prescriptions</p>
            </div>
            <button
