...
import { FileText, Plus, Search, Download, Eye, Edit2, Trash2, Calendar, User } from 'lucide-react'
  ...
  const [notes, setNotes] = useState([
    {
      ...
      content: 'Patient presented with chest pain and shortness of breath. Vital signs show elevated BP. Recommended cardiology referral and increased medication monitoring.',
    ...
    },
    {
      ...
      content: 'Complete blood count and metabolic panel completed. Results within normal range except for slightly elevated troponin levels (0.08 ng/mL). Recommend cardiac enzyme monitoring.',
    ...
    },
    {
      ...
      author: 'Dr. Sarah Smith',
      content: 'Patient discharged after 5 days of hospitalization. Primary diagnosis: Acute respiratory infection. Treated with antibiotics and supportive care. Follow-up appointment scheduled in 1 week.',
    ...
    },
    {
      ...
      content: 'Reviewed all current medications for potential interactions. Recommended discontinuation of Albuterol as patient shows improvement. Continue current BP management regimen.',
    ...
    },
    {
      ...
      author: 'Dr. Sarah Smith',
      content: 'Tissue biopsy shows no malignancy. Findings consistent with benign inflammatory lesion. Recommend monitoring and clinical follow-up at 6-month intervals.',
    ...
    },
    {
      ...
      author: 'Dr. John Wilson',
      content: 'CT scan of chest shows mild subcutaneous emphysema, likely post-procedure related. No acute findings. Lungs clear. Recommend follow-up imaging in 4 weeks.',
    ...
    },
    {
      ...
      author: 'Dr. Michael Brown',
      content: 'Patient attended occupational therapy session. Good progress observed with range of motion exercises. Continue current therapy plan. Patient compliant with home exercises.',
    ...
    },
    {
      ...
      author: 'Dr. Sarah Smith',
      content: 'Patient cleared for elective surgery. All pre-operative tests completed and within acceptable range. NPO after midnight. Medications reviewed with anesthesia team.',
        ...
        <main className="flex-1 p-6">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-slate-400">Clinical notes, lab reports, and medical documentation</p>
            </div>
            <button
