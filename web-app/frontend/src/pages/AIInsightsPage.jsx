...
import { Brain, TrendingUp, AlertCircle, CheckCircle, ThumbsUp, Target, Zap, Clock, User } from 'lucide-react'
  ...
  const [insights] = useState([
    {
      ...
      severity: 'HIGH',
      confidence: 94,
      description: 'Aspirin + Lisinopril may increase potassium levels. Monitor K+ levels weekly.',
    ...
    },
    {
      ...
      severity: 'HIGH',
      confidence: 87,
      description: 'Patient shows 3 risk factors: Low adherence, high BP variability, missed follow-up',
    ...
    },
    {
      ...
      severity: 'MEDIUM',
      confidence: 81,
      description: 'Current Metoprolol dosage shows suboptimal effect. Increasing to 75mg may improve control.',
    ...
    },
    {
      ...
      severity: 'LOW',
      confidence: 76,
      description: 'Patient BP shows 15% improvement after 2 weeks of exercise regimen compliance.',
    ...
    },
    {
      ...
      severity: 'MEDIUM',
      confidence: 89,
      description: 'Creatinine levels trending up (0.8→1.1). May indicate early kidney dysfunction.',
      recommendation: 'Order comprehensive metabolic panel, assess eGFR, monitor renal function',
      action: 'Order Tests',
    ...
    },
    {
      ...
      severity: 'LOW',
      confidence: 72,
      description: 'HR peaks at 2 AM, indicating possible sleep disturbance or nocturnal arrhythmia.',
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-6">
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-400">AI-powered clinical insights and risk assessments for patient care</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            <div className="bg-slate-900 border border-slate-700 rounded-lg p-4">
              ...
              <p className="text-2xl font-bold text-white">{insights.filter(i => !i.addressed).length}</p>
            </div>
            <div className="bg-slate-900 border border-slate-700 rounded-lg p-4">
            ...
            <div className="bg-slate-900 border border-slate-700 rounded-lg p-4">
              ...
              <p className="text-2xl font-bold text-amber-400">{riskAssessments.length}</p>
            </div>
            <div className="bg-slate-900 border border-slate-700 rounded-lg p-4">
