...
import { Cpu, Plus, Search, Activity, Wifi, Battery, Signal, AlertTriangle } from 'lucide-react'
...
const DeviceManagementPage = () => {
  ...
  const [devices, setDevices] = useState([
    ...
    },
    {
      ...
      sensors: [
        { name: 'Glucose', status: 'warning', value: '156 mg/dL' },
      ],
      firmware: 'v3.1.2',
      storageUsed: 78,
      alerts: 3,
        ...
        <main className="flex-1 p-6">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-slate-400">Monitor and manage IoT devices and wearables</p>
            </div>
            <button
