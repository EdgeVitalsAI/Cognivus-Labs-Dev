import { FileText, Download, Trash2, Eye, Tag, Lock } from 'lucide-react'
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="flex-1">
          ...
          <div className="flex items-center gap-2 mb-3">
            <span className={`text-xs font-bold px-2.5 py-1 rounded-full ${getTypeColor(note.type)}`}>
              {note.type}
            </span>
          ...
          <div className="grid grid-cols-3 gap-4 mb-3 text-sm text-slate-300">
            <div>
              <p className="text-xs text-slate-400 uppercase tracking-wider mb-0.5">Patient</p>
              <p className="font-semibold">{note.patient}</p>
            </div>
            <div>
              <p className="text-xs text-slate-400 uppercase tracking-wider mb-0.5">Author</p>
